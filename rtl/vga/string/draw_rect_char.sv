 ...
 * Author:        Bartłomiej Raczyński / Eryk Rutka
 * Version:       1.1 (Local Coordinates Fix)
 ...
 module draw_rect_char #(
     ...
     always_comb begin : apply_pixels_comb
         if (pipe_out.in_rect) begin
             // FIX: Pixel column relative to X_POS and not the screen
             bit_col = 3'(pipe_out.hcount - X_POS);
             bit_on = char_line_pixel[ ~bit_col ];
         end else begin
             bit_on = 1'b0;
         end
